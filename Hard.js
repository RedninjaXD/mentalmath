...
function generate() {
    ...
    if (operation === 0) {
        firstOneOrTwo = Math.random()
        if (firstOneOrTwo < 0.5) {
        ...
        if (firstNumber < 10) {
            secondNumber = Math.floor(Math.random()*41) + 10;
        } else {
            secondNumber = Math.floor(Math.random()*51);
        }
        question = String(firstNumber) + " × " + String(secondNumber);
        answer = firstNumber * secondNumber;
    } else {
        ...
        } while (firstNumber > 299 || (firstNumber < 10 && secondNumber < 10));
        question = String(firstNumber) + " ÷ " + String(secondNumber);
    }
    ...
    if (correct === 0) {
        ...
        do {
            ...
            oneToThree = Math.random() > 0.75 ? 299 : 99
            choice = Math.floor((Math.random()*oneToThree) + 1) * negOrPos;
        } while (choice === answer);
